...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('price', models.DecimalField(decimal_places=2, default='49.25', max_digits=9999999999)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.DecimalField(decimal_places=2, default='49.25', max_digits=9999999999)),
                ('total', models.DecimalField(decimal_places=2, default='49.25', max_digits=9999999999)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(default='product.jpg', upload_to=core.models.user_dict_path)),
                ('description', models.TextField(blank=True, default='This is the product', null=True)),
                ('price', models.DecimalField(decimal_places=2, default='49.25', max_digits=9999999999)),
                ('old_price', models.DecimalField(decimal_places=2, default='79.25', max_digits=9999999999)),
                ...
                ('categories', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.category')),
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('images', models.ImageField(default='product_img.jpg', upload_to='product-images')),
                ('date', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(default='Ton', max_length=100)),
                ('image', models.ImageField(default='vendor.jpg', upload_to=core.models.user_dict_path)),
                ('description', models.TextField(blank=True, default='This is the amazing vendor', null=True)),
                ('address', models.CharField(default='123 Pampanga.', max_length=100)),
                ('contact', models.CharField(default='+63xxx xxx xxxx', max_length=100)),
